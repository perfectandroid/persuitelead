...
object DecimelFormatters {

    fun setDecimelPlace(edtText: EditText) {

        edtText!!.addDecimalLimiter(2)
    }
    ...
    fun set2DecimelPlace(f: Float): String {
        val twoDigitsF = java.lang.String.format("%.02f", f)
